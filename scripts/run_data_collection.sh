...
#RUST_LOG=info cargo run --release --manifest-path=../Cargo.toml --bin summarize_dataset codeforces
#RUST_LOG=info cargo run --release --manifest-path=../Cargo.toml --bin summarize_dataset ctf
#RUST_LOG=info cargo run --release --manifest-path=../Cargo.toml --bin dance
